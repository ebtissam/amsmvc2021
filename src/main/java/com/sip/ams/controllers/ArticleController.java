...
import com.sip.ams.repositories.AticleRepository;
import com.sip.ams.repositories.ProviderRepository;

@Controller
@RequestMapping("/article/")
public class ArticleController {
	private final AticleRepository articleRepository;
	private final ProviderRepository providerRepository;

	@Autowired
	public ArticleController(AticleRepository articleRepository, ProviderRepository providerRepository) {
